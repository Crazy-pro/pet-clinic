...
public class OwnerControllerTest {
    ...
    public void setUp() {
        ...
        ownersMock.add(Owner.builder().id(1L).city("Minsk").build());
    ...
    @Test
    public void testProcessFindFormReturnMany() throws Exception {
    ...
    @Test
    public void testProcessFindFormReturnOne() throws Exception {
